              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200 hover:bg-blue-100 transition-colors">
                    <div className="text-2xl font-bold text-[#005bac]">450억</div>
                  ...
                  <div className="p-4 bg-orange-50 rounded-lg border border-orange-200 hover:bg-orange-100 transition-colors">
                    <div className="text-2xl font-bold text-[#ff6600]">562개</div>
              ...
              <div className="space-y-6">
                <div className="p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg border-2 border-blue-200 hover:border-[#005bac]/50 transition-all">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-lg font-semibold text-[#005bac]">일반형</p>
                      <p className="text-sm text-gray-600 mt-1">1:1 협력 구조, 예비 414개 + 사업화 148개</p>
                    </div>
                    <div className="text-right">
                      <p className="text-2xl font-bold text-[#005bac]">351억원</p>
                    </div>
                  </div>
                </div>
                <div className="p-4 bg-gradient-to-r from-orange-50 to-white rounded-lg border-2 border-orange-200 hover:border-[#ff6600]/50 transition-all">
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="text-lg font-semibold text-[#ff6600]">컨소시엄형</p>
                      <p className="text-sm text-gray-600 mt-1">국가 전략기술, 레전드 50+ 과제</p>
                    </div>
                    <div className="text-right">
                      <p className="text-2xl font-bold text-[#ff6600]">100억원</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#005bac] mb-2">중소기업</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-[#ff6600] mb-2">대학</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-green-600 mb-2">연구기관</h3>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-8 bg-gradient-to-br from-blue-50 to-white rounded-xl border-2 border-blue-200 hover:border-[#005bac]/50 transition-all">
                <h3 className="text-xl font-semibold text-[#005bac] mb-4">기업 혜택</h3>
              ...
              <div className="p-8 bg-gradient-to-br from-orange-50 to-white rounded-xl border-2 border-orange-200 hover:border-[#ff6600]/50 transition-all">
                <h3 className="text-xl font-semibold text-[#ff6600] mb-4">대학/연구기관 혜택</h3>
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
